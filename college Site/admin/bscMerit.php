...
function download()
{
	window.location='BSC_report.xls';
}
</script>
<div id="content">
...
<h2 align="center"><a href="javascript:void(0);" onClick="download();">Generate Report For B.Sc</a></h2>
...
$excel=new ExcelWriter("BSC_report.xls");
if($excel==false)	
echo $excel->error;
