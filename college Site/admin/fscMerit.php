...
function download()
{
	window.location='FSC_report.xls';
}
</script>
...
<div id="content">
 ...
 <h2 align="center"><a href="javascript:void(0);" onClick="download();">Generate Report For F.Sc</a></h2>
	<?php
/*
	* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
$excel=new ExcelWriter("FSC_report.xls");
if($excel==false)	
echo $excel->error;
