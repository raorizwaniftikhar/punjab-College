...
function download()
{
	window.location='ICS_report.xls';
}
</script></strong>
<div id="content">
...
<h2 align="center"><a href="javascript:void(0);" onClick="download();">Generate Report For I.C.S</a></h2>
	<?php
/*
	* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
$excel=new ExcelWriter("ICS_report.xls");
if($excel==false)	
echo $excel->error;
