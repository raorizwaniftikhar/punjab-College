...
<div id="content">
    ...
    <h2 align="center"><a href="javascript:void(0);" onClick="download();">Generate Report For F.A</a></h2>
	<?php
/*
	* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
$excel=new ExcelWriter("FA_report.xls");
if($excel==false)	
echo $excel->error;
