...
<center>
	<h2><?php  $listId=$_GET['list_id'];
				if($listId=='1') 
					echo "First Merit List For B.A";
				else if($listId=='2') 
					echo "Second Merit List For B.A";
				else if($listId=='3') 
				echo "Third Merit List For B.A"
				 ?> 
	</h2>
</center>
	<table>
		<tr bgcolor="#666666">
			...
			*/?>
            <?php 
				...
				$quer = "select * from student s, academic c where status='".$_GET['list_id']."' AND prog_id='p5' AND s.std_id=c.std_id AND per_class='Intermediate' order by obtain_marks desc";
